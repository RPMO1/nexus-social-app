                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="t13">
                                                                                            <p class="t12"
                                                                                                ...
                                                                                                Here’s your code to reset your password securely.
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <table class="t22" role="presentation"
                                                                        ...
                                                                        style="Margin-right:auto;">
                                                                        <tr>
                                                                            <td style="background-color:#000000; width:100%; padding:0; text-align:center;">
                                                                                <table role="presentation" cellpadding="0" cellspacing="0" 
                                                                                    style="width:auto; background-color:#000000; border-radius:20px; margin:0 auto;">
                                                                                    <tr>
                                                                                        <td style="text-align:center; line-height:28px; mso-line-height-rule:exactly; 
                                                                                                padding:10px 20px; border-radius:20px;">
                                                                                            <h2 style="margin:0; font-family:Sofia Sans, BlinkMacSystemFont, Segoe UI, Helvetica Neue, Arial, sans-serif; 
                                                                                                    line-height:28px; font-weight:700; font-style:normal; font-size:20px; 
                                                                                                    text-decoration:none; text-transform:none; letter-spacing:-0.2px; 
